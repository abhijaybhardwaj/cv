    ...
    */
		...
		function createMountainRange(mountainAmount, height,  color) {
			for (var i = 0; i < mountainAmount; i++) {
				...
				c.lineTo(i * mountainWidth + mountainWidth + 225, canvas.height);

				// Triangle peak
				c.lineTo(i * mountainWidth + mountainWidth / 2, canvas.height - height);
				c.lineTo(i * mountainWidth - 225, canvas.height);
				c.fillStyle = color;
				c.fill();
				c.closePath();
			}
    ...
    */
		...
		backgroundGradient.addColorStop(0,"#332b5e");
		backgroundGradient.addColorStop(1,"#e9e5d9");
		...
		function animate() {
			...
			createMountainRange(1, canvas.height - 50, "#5a8cd4bd");
			createMountainRange(2, canvas.height - 100,  "#718fce");
			createMountainRange(3, canvas.height - 300 , "#221563");
